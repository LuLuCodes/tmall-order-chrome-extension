...
async function getHtml() {
  const res = await axios({
    ...
    data: { pageNum: 1, pageSize: 15, prePageNo: 1 },
    headers: {
      ...
      'user-agent':
        'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_1_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.72 Safari/537.36 Edg/89.0.774.45',
